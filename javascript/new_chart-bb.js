        ...
        polar: [
            {
                radius:90,
                indicator: [
                    {text: '销售量',max: 100},/*(Sales) (Refund Rate) (Negative Evaluation) (Complaints Report) (Disease) (Warning) (Public Opinions)*/
                    {text: '退货率', max: 100},
                    {text: '负面评价', max: 100},
                    {text: '投诉举报', max: 100},
                    {text: '疫情疫病', max: 100},
        ...
        series: [
            ...
            },
            {
                ...
                markLine : {
                    ...
                    data : [
                        [{name:'杭州', smoothness:0.4}, {name:'欧洲',value:200}],
                        [{name:'欧洲', smoothness:0.3}, {name:'杭州',value:90}]
                    ]
                },
                markPoint : {
                    symbol:'emptyCircle',
            ...
            },
            {
                ...
                markLine : {
                    ...
                    data : [
                        [{name:'杭州', smoothness:0.2}, {name:'南美洲',value:950}],
                        [{name:'南美洲', smoothness:0.3}, {name:'杭州',value:90}],
                    ]
                }
            },
            {
                ...
                markLine : {
                    ...
                    data : [
                        [{name:'杭州', smoothness:0.2}, {name:'大洋洲',value:950}],
                        [{name:'大洋洲', smoothness:0.3}, {name:'杭州',value:90}],
            ...
            },
            {
                ...
                markLine : {
                    ...
                    data : [
                        [{name:'杭州', smoothness:0.2}, {name:'北美洲',value:95}],
                        [{name:'北美洲', smoothness:0.3}, {name:'杭州',value:90}]
            ...
            },
            {
                ...
                markLine : {
                    ...
                    data : [
                        [{name:'杭州', smoothness:0.2}, {name:'非洲',value:95}],
                        [{name:'非洲', smoothness:0.3}, {name:'杭州',value:90}]
